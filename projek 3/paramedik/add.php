...
if (isset($_POST["submit"])) {
    ...
    $_tmp_lahir_ = $_POST['tmp_lahir'];
    $_tgl_lahir_ = $_POST['tgl_lahir'];
    $_kategori = $_POST['kategori'];
    $_telepon = $_POST['telepon'];
    $_alamat = $_POST['alamat'];
    $_unit_kerja = $_POST['unit_kerja'];
    $data = [$_id, $_nama, $_gender, $_tmp_lahir, $_tgl_lahir, $_kategori, $_telepon, $_alamat, $_unit_kerja];
    $sql = "INSERT INTO pasien (id, nama, gender, tempat lahir, tanggal lahir, kategori, telepon, alamat, unit kerja) VALUES (?,? ,? ,? ,? ,? ,? ,?)";
